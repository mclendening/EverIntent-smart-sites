  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium tracking-wide ring-offset-background transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // CTA: Matches "Need help?" chat button - subtle hover with icon brightness
        glow: "bg-primary/95 backdrop-blur-sm text-primary-foreground border border-accent/30 shadow-lg hover:bg-primary hover:border-accent hover:shadow-accent/20 group",
        "glow-outline": "bg-transparent text-accent border border-accent/30 shadow-lg hover:bg-accent/10 hover:border-accent hover:shadow-accent/15 group",
        // Solid amber style (for contrast when needed)
        premium: "bg-accent text-primary font-semibold shadow-lg hover:brightness-110 group",
        "premium-dark": "bg-primary/95 backdrop-blur-sm text-primary-foreground border border-accent/30 shadow-lg hover:bg-primary hover:border-accent hover:shadow-accent/20 group",
      },
      size: {
        default: "px-4 py-2.5",
