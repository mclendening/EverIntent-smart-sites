...
const smartWebsitesTiers = [
  { title: 'Launch', path: '/smart-websites/launch', description: '$249 one-time' },
  { title: 'Capture', path: '/smart-websites/capture', description: '$97/mo' },
  { title: 'Convert', path: '/smart-websites/convert', description: '$197/mo' },
  { title: 'Scale', path: '/smart-websites/scale', description: '$297/mo' },
