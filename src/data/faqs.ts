...
export const faqData: FAQItem[] = [
  ...
  // ──────────────────────────────────────────
  // TRUSTED AI UPGRADE — Reliability & control
  // ──────────────────────────────────────────
  {
    id: 'trusted-ai-what-is-it',
    question: "What exactly is the Trusted AI Upgrade?",
    answer: "Trusted AI is the version of your AI Employee that only says what you approved. We build your conversation flow on a visual canvas, run it in staging, and ship it after you sign off. It is the same AI Employee, with a deterministic guardrail layer wrapped around it so it cannot drift, hallucinate, or invent answers it has not been trained on.",
    category: 'ai-employee',
    tags: ['trusted-ai', 'reliability', 'product'],
    products: ['trusted-ai', 'web-chat', 'after-hours', 'front-office', 'full-ai', 'scale'],
    priority: 1,
    isObjection: true,
  },
  {
    id: 'trusted-ai-why-extra',
    question: "Why does it cost extra if it is the same AI Employee?",
    answer: "Two reasons. First, the $497 covers the visual build, staging, and approval cycle for your specific business. Second, the $147 a month covers the deterministic guardrail layer, the version control, and the staged update workflow that prevents drift on every change. Standard AI is cheaper because it skips that work and accepts that some answers will be wrong.",
    category: 'pricing',
    tags: ['trusted-ai', 'reliability', 'pricing', 'objection'],
    products: ['trusted-ai'],
    priority: 2,
    isObjection: true,
  },
  {
    id: 'trusted-ai-air-canada',
    question: "Could my business actually be liable for what the AI says?",
    answer: "Yes. A Canadian court ruled an airline was legally liable for the policy its chatbot invented. The legal precedent is clear: your AI's lies are your lies. Trusted AI is the version that does not invent. If a customer asks something outside what you approved, the AI says so and routes the question to a human, instead of guessing.",
    category: 'ai-employee',
    tags: ['trusted-ai', 'reliability', 'compliance'],
    products: ['trusted-ai'],
    priority: 3,
  },
  {
    id: 'trusted-ai-vs-standard',
    question: "How is Trusted AI different from your standard AI Employee?",
    answer: "Standard AI generates an answer based on its training. Trusted AI executes the script you approved. Standard AI updates itself when the model updates. Trusted AI updates only when you approve a new version in staging. Standard AI confidence is a feature. Trusted AI accuracy is a feature.",
    category: 'ai-employee',
    tags: ['trusted-ai', 'reliability', 'product'],
    products: ['trusted-ai'],
    priority: 4,
  ...
  {
    id: 'trusted-ai-doesnt-know',
    question: "What happens when a customer asks something the AI does not know?",
    answer: "It does not guess. The AI tells the customer it does not have that answer, captures the question, and routes the conversation to you (text, email, or call). You see exactly what was asked, you answer once, and we add it to the approved script for next time. Drift becomes impossible because the AI never speaks outside what you approved.",
    category: 'ai-employee',
    tags: ['trusted-ai', 'reliability', 'product'],
    products: ['trusted-ai'],
    priority: 5,
  ...
  {
    id: 'trusted-ai-update',
    question: "How do updates work? Can the AI change without my knowing?",
    answer: "No. Every change to your script lives on a visual canvas, gets tested in staging, and waits for your approval before it goes live. You see the diff. You approve the version. Nothing ships otherwise. If something goes wrong, you roll back to the previous approved version in one click.",
    category: 'ai-employee',
    tags: ['trusted-ai', 'reliability', 'product'],
    products: ['trusted-ai'],
    priority: 6,
  ...
  {
    id: 'trusted-ai-add-later',
    question: "Can I add Trusted AI later, after I see how standard AI performs?",
    answer: "Yes. You can add it at any time. Just remember that every conversation between now and then is one you cannot take back. If standard AI quotes a wrong price, books an appointment you cannot keep, or invents a service you do not offer, that customer experience already happened. Trusted AI is the prevention, not the cure.",
    category: 'ai-employee',
    tags: ['trusted-ai', 'reliability', 'objection'],
    products: ['trusted-ai'],
    priority: 7,
  },
  {
    id: 'trusted-ai-which-tiers',
    question: "Which plans can add Trusted AI?",
    answer: "Trusted AI is available on every AI Employee tier (Web Chat, After-Hours, Front Office, Full AI Employee) and on the Smart Websites Scale plan, which bundles AI Chat. It is not offered on Launch, Capture, or Convert because those plans do not include AI conversation features.",
    category: 'ai-employee',
    tags: ['trusted-ai', 'product', 'pricing'],
    products: ['trusted-ai', 'web-chat', 'after-hours', 'front-office', 'full-ai', 'scale'],
    priority: 8,
  },
];
