...
export default function HealthWellness() {
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative py-16 md:py-24 bg-gradient-to-b from-background to-card/50" aria-label="Health and wellness AI solutions">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button asChild size="lg">
                <a href="/pricing">View Plans for Practices</a>
              </Button>
