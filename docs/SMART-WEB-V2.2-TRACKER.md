...
| 6.16 | Decouple gold accent from theme system | `in-progress` | B1 | Gold persists on checkout; homepage logo stays purple | Dedicated `--gold` CSS var immune to theme overrides. Pending full production verification. |
