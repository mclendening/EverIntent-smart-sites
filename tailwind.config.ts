  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "display-2xl": ["5rem", { lineHeight: "1", letterSpacing: "-0.03em", fontWeight: "600" }],
        "display-xl": ["4rem", { lineHeight: "1.05", letterSpacing: "-0.02em", fontWeight: "600" }],
        "display-lg": ["3.25rem", { lineHeight: "1.1", letterSpacing: "-0.02em", fontWeight: "600" }],
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(38 70% 55% / 0.2)" },
